SET search_path TO qr_entry_control;
...
values (1, 700484, 418346, '2021-07-11 12:33:16', 'OUT', 'Главная проходная', 'ACTIVE', 'А111АА 77', true, '{
  "message": "ошибка сервиса барьер",
  "statusCode": 500,
  "erroredServiceName": "барьер"
}');
insert into events (event_id, common_id, entry_device_value, event_time, event_type, info, state_of_action, gos_number,
                    is_errored, description)
...
insert into events (event_id, common_id, entry_device_value, event_time, event_type, info, state_of_action, gos_number,
                    is_errored, description)
values (13, 770649, 808475, '2021-08-22 04:00:14', 'IN', 'Административный корпус', 'UNKNOWN', NULL, false,
        NULL);
insert into events (event_id, common_id, entry_device_value, event_time, event_type, info, state_of_action, gos_number,
                    is_errored, description)
...
insert into events (event_id, common_id, entry_device_value, event_time, event_type, info, state_of_action, gos_number,
                    is_errored, description)
values (40, 777456, 381855, '2021-07-10 10:17:03', 'IN', 'Административный корпус', 'UNKNOWN', NULL, false,
        NULL);
insert into events (event_id, common_id, entry_device_value, event_time, event_type, info, state_of_action, gos_number,
                    is_errored, description)
